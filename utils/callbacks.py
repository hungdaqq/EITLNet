...
class EvalCallback:
    ...
    def on_epoch_end(self, epoch, model_eval):
        if epoch % self.period == 0 and self.eval_flag:
            self.net = model_eval
            gt_dir = os.path.join(self.dataset_path, "Masks01/")
            ...
            for image_id in tqdm(self.image_ids):
                ...
                path_t = os.path.join(
                    os.path.join(self.dataset_path, "Images/" + image_id + ".jpg")
                )
                path_t_png = os.path.join(
                    os.path.join(self.dataset_path, "Images/" + image_id + ".png")
                )
                if os.path.isfile(path_t):
                    ...
                    image_path = os.path.join(
                        os.path.join(self.dataset_path, "Images/" + image_id + ".tif")
                    )
